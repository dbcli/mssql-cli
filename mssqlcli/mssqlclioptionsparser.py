...
def create_parser():
    ...
    args_parser.add_argument(
        ...
        action=u'store_true',
        default=False,
        help=_(u'If application is connecting to AlwaysOn AG on different subnets, setting this provides faster detection and connection to currently active server.'))
